...
async function run() {
    try {
        ...
        const translationHistoryCollection = deltaTranslateDB.collection('translationHistoryCollection');
        ...
        app.put('/translation-history/:email', async (req, res) => {
            ...
            if (existingUser) {
                ...
                const updateResult = await translationHistoryCollection.updateOne(filter, updatedDoc, options);
                res.send(updateResult);
            } else {
                const insertResult = await translationHistoryCollection.insertOne(updatedTranslationHistory);
